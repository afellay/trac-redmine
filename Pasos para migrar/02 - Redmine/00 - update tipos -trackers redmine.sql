...
UPDATE issues   SET  tracker_id= 2 WHERE tracker_id = 9;

DELETE FROM trackers WHERE id = 9;

 -- "Bug (☹)"

UPDATE issues SET  tracker_id= 1 WHERE tracker_id = 11;

DELETE FROM trackers WHERE id = 11;
