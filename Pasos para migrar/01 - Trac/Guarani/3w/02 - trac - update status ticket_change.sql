...
UPDATE ticket_change SET oldvalue= 'Listo Para Testeo' WHERE field = 'status' and oldvalue= 'ListoDesarrollo';
UPDATE ticket_change SET newvalue= 'Listo Para Testeo' WHERE field = 'status' and newvalue= 'ListoDesarrollo';
UPDATE ticket_change SET oldvalue= 'Listo Para Testeo' WHERE field = 'status' and oldvalue= 'ListoRevisionCodigo';
UPDATE ticket_change SET newvalue= 'Listo Para Testeo' WHERE field = 'status' and newvalue= 'ListoRevisionCodigo';
...
UPDATE ticket_change SET newvalue= 'Listo Para Documentacion' WHERE field = 'status' and oldvalue= 'ListoParaDocumentacion';
UPDATE ticket_change SET oldvalue= 'Listo Para Documentacion' WHERE field = 'status' and newvalue= 'ListoTesteo';
UPDATE ticket_change SET newvalue= 'Listo Para Documentacion' WHERE field = 'status' and newvalue= 'ListoTesteo';
...
UPDATE ticket_change SET oldvalue= 'En Testeo' WHERE field = 'status' and oldvalue= 'EnRevisionCodigo';
UPDATE ticket_change SET newvalue= 'En Testeo' WHERE field = 'status' and newvalue= 'EnRevisionCodigo';
