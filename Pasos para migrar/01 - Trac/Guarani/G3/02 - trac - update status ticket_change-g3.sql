...
UPDATE ticket SET status= 'Listo Para Testeo' WHERE status= 'ListoRevisionCodigo';
UPDATE ticket SET status= 'Listo Para Testeo' WHERE status= 'EnRevisionCodigo';
...
UPDATE ticket_change SET newvalue= 'Listo Para Testeo' WHERE field = 'status' and newvalue= 'EnRevisionCodigo';
UPDATE ticket_change SET oldvalue= 'Listo Para Testeo' WHERE field = 'status' and oldvalue= 'EnRevisionCodigo';
...
UPDATE ticket_change SET oldvalue= 'Nuevo' WHERE field = 'status' and oldvalue= 'RequiereInformacion';
UPDATE ticket_change SET newvalue= 'Nuevo' WHERE field = 'status' and newvalue= 'RequiereInformacion';
UPDATE ticket_change SET oldvalue= 'Nuevo' WHERE field = 'status' and oldvalue= 'PendienteRespuesta';
UPDATE ticket_change SET newvalue= 'Nuevo' WHERE field = 'status' and newvalue= 'PendienteRespuesta';
